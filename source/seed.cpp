...
static void Update(void) {
  if (waitForInput) {
    if (cl::JustPressed<cl::KEY_ENTER>()) {
    ...
    } else if (cl::JustPressed<'0'>())
      inputBuffer += '0';
    else if (cl::JustPressed<'1'>())
      inputBuffer += '1';
      ...
      inputBuffer += '4';
    else if (cl::JustPressed<'5'>())
      inputBuffer += '5';
    else if (cl::JustPressed<'6'>())
      inputBuffer += '6';
    else if (cl::JustPressed<'7'>())
      inputBuffer += '7';
    else if (cl::JustPressed<'8'>())
      inputBuffer += '8';
    else if (cl::JustPressed<'9'>())
      inputBuffer += '9';
    ...
    if (Game::curArea != nullptr) Game::DeleteWorld();
