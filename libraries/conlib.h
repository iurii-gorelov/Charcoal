...
void Put(unsigned char c, int x, int y, unsigned char fg = 255,
         unsigned char bg = 255);

unsigned short& AttrAt(int x, int y);

void Fill(unsigned char c, int x, int y, int w, int h, unsigned char fg = 255,
          unsigned char bg = 255);

void Write(std::string text, int x, int y, int maxw = 999);
